...
// TestE2ESandbox tests the full sandbox functionality with real srt.
// Requires: DOPPLER_TOKEN env var, srt installed
func TestE2ESandbox(t *testing.T) {
	...
	for _, dir := range []string{projectDir, dataDir, policyDir} {
...
`, dopplerProject, dopplerConfig, policyDir, projectDir, projectDir, dataDir)
