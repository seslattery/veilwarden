...
func TestNewStore_DopplerConfigured(t *testing.T) {
...
func TestNewStore_DopplerNoCacheTTL(t *testing.T) {
...
func TestNewStore_NoDopplerConfig(t *testing.T) {
...
func TestNewStore_MemoryStoreLoadsFromRoutes(t *testing.T) {
...
func TestNewStore_InvalidCacheTTL(t *testing.T) {
...
func TestNewStore_EmptyRoutesMemoryStore(t *testing.T) {
